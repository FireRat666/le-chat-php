...
This is a PHP Chat based on LE CHAT v.1.14. An Copy of this script can be downloaded at https://github.com/FireRat666/le-chat-php
...
If you want to see the script in action, you can visit my [TOR hidden service](http://mefxfirerat6trnw.onion/chat.php) or via a tor2web proxy like [this one](https://mefxfirerat6trnw.onion.link/chat.php) if you don't have TOR installed.
